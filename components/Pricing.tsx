        ...
        >
           <PriceCard className="w-full">
             <div className="relative overflow-hidden flex flex-col lg:flex-row items-stretch group/main">
                ...
                <div className="flex-1 p-4 md:p-7 border-b lg:border-b-0 lg:border-r border-white/5 group-hover/main:border-brand-purple/20 transition-colors duration-300 flex flex-col justify-center gap-3 relative z-10">
                ...
                <div className="flex-[1.2] p-4 md:p-7 transition-colors duration-300 space-y-3.5 bg-white/[0.01] relative z-10">
                ...
                <div className="flex-1 p-4 md:p-7 flex flex-col items-center justify-center gap-5 bg-zinc-900/60 relative z-10">
           ...
           <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-3.5">
              <PriceCard className="p-4 md:p-6 flex flex-col justify-between gap-5 group/main h-full">
