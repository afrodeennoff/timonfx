...
const JournalHeader: React.FC<{ label: string }> = ({ label }) => (
  <div className="px-4 py-3 border-r border-white/5 last:border-0">
    <span className="mono text-[9px] text-zinc-600 font-black tracking-[0.2em] uppercase italic">{label}</span>
  </div>
);
    ...
    >
      <div className="mb-10 space-y-4">
        <div className="flex items-center gap-3">
          ...
          <span className="mono text-[10px] text-brand-purple font-black tracking-[0.5em] uppercase italic">EXECUTION_LOGS_v1.0</span>
        </div>
      ...
      <div className={`flex-1 flex flex-col ${GLASS_STYLES.card} overflow-hidden relative group/journal`}>
        ...
        {/* Empty State Content */}
        <div className="flex-1 flex flex-col items-center justify-center p-12 text-center space-y-8 relative z-10">
          <div className="space-y-4">
            <div className="flex justify-center mb-6">
              <div className="relative">
                <div className="w-16 h-16 rounded-2xl border border-white/5 bg-white/[0.01] flex items-center justify-center">
                  <svg className="w-6 h-6 text-zinc-800" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
            ...
            <p className="mono text-[11px] text-zinc-500 uppercase tracking-widest leading-relaxed max-w-xs mx-auto font-bold italic">
          ...
          <div className="flex flex-col items-center gap-6 pt-10 border-t border-white/5 w-full max-w-sm">
