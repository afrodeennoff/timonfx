    ...
    >
      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-16 lg:gap-32 items-center relative z-10">
         <motion.div variants={VARIANTS.reveal} className="w-full lg:w-5/12 relative group">
            <div className="aspect-[4/5] bg-zinc-950 overflow-hidden relative border border-white/20 shadow-2xl flex items-center justify-center p-12">
               <img 
                 ...
                 className="w-full h-full object-contain opacity-80 group-hover:opacity-100 transition-all duration-700 ease-[0.22,1,0.36,1] filter drop-shadow-[0_0_20px_rgba(255,255,255,0.2)]"
                 loading="lazy"
               />
         ...
         <div className="w-full lg:w-7/12 space-y-10 md:space-y-16">
            ...
            <motion.div variants={VARIANTS.reveal} className="space-y-8 md:space-y-12">
            ...
            <motion.button 
              ...
              className="group relative w-full sm:w-auto px-12 md:px-16 py-6 md:py-8 bg-white/5 border border-white/20 hover:border-brand-purple transition-all duration-300 mono text-[10px] md:text-[11px] font-black text-white uppercase tracking-[0.4em] overflow-hidden focus:outline-none focus-visible:ring-1 focus-visible:ring-brand-purple"
            >
              <div className="absolute inset-0 bg-brand-purple translate-y-full group-hover:translate-y-0 transition-transform duration-300 ease-[0.22,1,0.36,1]" />
              <span className="relative z-10 group-hover:text-white transition-colors duration-300 font-black">REQUEST ACCESS</span>
            </motion.button>
         </div>
      </div>
      <style>{`
